...
public class BaoGaoAdapter3 extends RecyclerView.Adapter<BaoGaoAdapter3.ViewHolder> {
    ...
    public BaoGaoAdapter3(List<HeiMingDanBean.ObjectsBean> datas, Context context, String zhuji) {
        this.datas = datas;
