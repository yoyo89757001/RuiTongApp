...
public class PopupList {
    ...
    public static final float DEFAULT_TEXT_PADDING_LEFT_DP = 14.0f;
    public static final float DEFAULT_TEXT_PADDING_TOP_DP = 10.0f;
    public static final float DEFAULT_TEXT_PADDING_RIGHT_DP = 14.0f;
    public static final float DEFAULT_TEXT_PADDING_BOTTOM_DP = 10.0f;
    ...
    private void showPopupListWindow() {
        ...
        if (!mPopupWindow.isShowing()) {
            mPopupWindow.showAtLocation(mAnchorView, Gravity.CENTER,
                    ...
                    (int) mRawY - mScreenHeight / 2 - mPopupWindowHeight + mIndicatorHeight-30);
        }
    }
